 ...
 let countdown_stopped = homey.flow.getTriggerCard('countdown_stopped');
  ...
  let countdown_timer_changed = homey.flow.getTriggerCard('countdown_timer_changed');
    ...
    .registerAutocompleteListener((query, args) => {
      ...
      let countdown_timer_changed_precise = homey.flow.getTriggerCard('countdown_timer_changed_precise');
      countdown_timer_changed_precise
          .registerRunListener((args, state) => {
              console.log('flow: countdown_timer_changed_precise ' + args.variable.name)
